...
const PrivacyPolicy = () => {
    return (
        <div className="privacy_policy container">
            <h1>Privacy Policy for Arc Coder</h1>

            <p>
                At Arc Coder, accessible from https://arccoder.in, one of our
                ...
                and recorded by Arc Coder and how we use it.
            </p>
            ...
            <p>
                ...
                information that they shared and/or collect in Arc Coder. This
            ...
            <p>
                Arc Coder follows a standard procedure of using log files. These
            ...
            <p>
                ...
                the advertising partners of Arc Coder.
            </p>

            <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on Arc Coder,
            ...
            <p>
                Note that Arc Coder has no access to or control over these
            ...
            <p>
                Arc Coder's Privacy Policy does not apply to other advertisers
            ...
            <p>
                Arc Coder does not knowingly collect any Personal Identifiable
